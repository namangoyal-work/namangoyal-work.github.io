...
export const aboutParagraphs: string[] = [
  ...
  "Next summer I join Virtu Financial as a software engineering intern. Before that: hardware-security research at CISPA, and the systems I build to sharpen the craft — a tick-to-trade FPGA pipeline, a low-latency C++ execution engine, quantum simulators. My background is competitive mathematics and science, and I apply it to real software and hardware engineering.",
];
